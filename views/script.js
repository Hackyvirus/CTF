...
// Array of Object of questions_1 
let questionset = [[{
        "id": 0,
        "question": "Python built-in function for finding the length of a list?",
        "answer": "len"
},
{
        "id": 1,
        "question": "C language syntax for declaring a pointer?",
        "answer": "*"
},
{
        "id": 2,
        "question": "JavaScript method for adding an element to the end of an array?",
        "answer": "push"
},
{
        "id": 3,
        "question": "Java keyword to define a constant variable?",
        "answer": "final"
},
{
        "id": 4,
        "question": "Electronic component that stores electrical charge?",
        "answer": "Capacitor"
},
{
        "id": 5,
        "question": "DBMS language for querying databases?",
        "answer": "SQL"
},
{
        "id": 6,
        "question": "Software testing level focused on system behavior?",
        "answer": "Functional"
},
{
        "id": 7,
        "question": "Python library for data visualization?",
        "answer": "Matplotlib"
},
{
        "id": 8,
        "question": "C function to open a file?",
        "answer": "fopen"
},
{
        "id": 9,
        "question": "JavaScript object notation abbreviation?",
        "answer": "JSON"
}
],
...
[
        {
                "id": 0,
                "question": "Data structure that follows Last In, First Out (LIFO) principle?",
                "answer": "Stack"
        },
        {
                "id": 1,
                "question": "Programming paradigm emphasizing immutability and pure functions?",
                "answer": "Functional Programming"
        },
        {
                "id": 2,
                "question": "Network protocol for secure communication over a computer network?",
                "answer": "HTTPS"
        },
        {
                "id": 3,
                "question": "Algorithm for sorting elements by repeatedly dividing the array into halves?",
                "answer": "Merge Sort"
        },
        {
                "id": 4,
                "question": "Operating system scheduling algorithm that assigns priority to each process?",
                "answer": "Priority Scheduling"
        },
        {
                "id": 5,
                "question": "Programming language commonly used for artificial intelligence and machine learning?",
                "answer": "Python"
        },
        {
                "id": 6,
                "question": "Web development framework for building single-page applications?",
                "answer": "React"
        },
        {
                "id": 7,
                "question": "Database model that organizes data into tables with rows and columns?",
                "answer": "Relational Database"
        },
        {
                "id": 8,
                "question": "Cybersecurity technique to protect against unauthorized access to data?",
                "answer": "Encryption"
        },
        {
                "id": 9,
                "question": "Concept in object-oriented programming where a class can inherit properties and behaviors from another class?",
                "answer": "Inheritance"
        }
],
...
[
        {
                "id": 0,
                "question": "Linux command for searching for a specific pattern in a file?",
                "answer": "grep"
        },
        {
                "id": 1,
                "question": "Web development language used for styling and layout of web pages?",
                "answer": "CSS"
        },
        {
                "id": 2,
                "question": "Programming language developed by Microsoft commonly used for Windows application development?",
                "answer": "C#"
        },
        {
                "id": 3,
                "question": "Database language for managing and manipulating relational databases?",
                "answer": "SQL"
        },
        {
                "id": 4,
                "question": "Concept in software engineering that involves breaking a problem into smaller, manageable parts?",
                "answer": "Decomposition"
        },
        {
                "id": 5,
                "question": "Software design pattern for creating objects without specifying the exact class?",
                "answer": "Factory Pattern"
        },
        {
                "id": 6,
                "question": "JavaScript library for building user interfaces, developed by Facebook?",
                "answer": "React"
        },
        {
                "id": 7,
                "question": "File format for exchanging structured data between systems?",
                "answer": "JSON"
        },
        {
                "id": 8,
                "question": "Computer network device that forwards data between networks?",
                "answer": "Router"
        },
        {
                "id": 9,
                "question": "Web protocol for transferring hypertext requests and information?",
                "answer": "HTTP"
        }
]
]
...
// get questionNumber 
let questionNumber = Math.floor((Math.random() * 9) + 1);


//send the question to page
document.getElementById("main-question").innerHTML = questionset[level][questionNumber]["question"]
...
function check() {
        if (questionset[level][questionNumber]["answer"].toLowerCase() == document.getElementById("input-ans").value.toLowerCase()) {
...
function useJoker() {
        ...
        document.getElementById("joker").innerText = questionset[level][questionNumber]["answer"]
        document.getElementsByClassName("joker-" + joker)[0].style = "display:none"
}

function nextquestion() {
        questionNumber = Math.floor((Math.random() * 9) + 1);
        if (question == 5) {
                level++;
